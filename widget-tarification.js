    ...
    return `
      ...
      <div class="timeline-container">
        ...
        <div class="timeline-info">
          ...
          <span class="status-badge ${currentStatus}">${statusLabels[currentStatus]}</span>
        </div>
        <div class="legend">
...
console.info('%c WIDGET-TARIFICATION %c v1.1.0 ', 'color: white; background: #e8a020; font-weight: bold;', 'color: #e8a020; background: white;');
